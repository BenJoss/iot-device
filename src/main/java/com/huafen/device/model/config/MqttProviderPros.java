...
@Component
@ConfigurationProperties(prefix = "mqttprv")
public class MqttProviderPros {
	 /**
     * 用户名
     */
	...
	public String[] getDmqInfo() {
		return dmqInfo;
	}
	public void setDmqInfo(String[] dmqInfo) {
		this.dmqInfo = dmqInfo;
	}
