...
-- ----------------------------
-- Table structure for t_iot_device_room
-- ----------------------------
DROP TABLE IF EXISTS `t_iot_device_room`;
CREATE TABLE `t_iot_device_room`  (
   ...
   `DEVICE_SWITCH` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL COMMENT '设备开关',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议室设备开关信息表';