...
-- ----------------------------
-- Table structure for t_iot_led_room
-- ----------------------------
DROP TABLE IF EXISTS `t_iot_led_room`;
CREATE TABLE `t_iot_led_room`  (
   ...
   `LED_SWITCH` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL COMMENT 'LED开关',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议室LED信息表';